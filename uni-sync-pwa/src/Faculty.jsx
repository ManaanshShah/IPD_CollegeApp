...
// src/Faculty.jsx
import { useNavigate } from 'react-router-dom';
import { ClipboardCheck, TrendingUp, Megaphone, CalendarDays, BarChart3 } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div style={{ padding: '20px', marginTop: '-30px' }}>
        ...
        <div style={styles.sectionTitle}>Analytics & Reports</div>
        <div className="card" style={{ display: 'flex', alignItems: 'center', padding: '15px', opacity: 0.7, userSelect: 'none', WebkitUserSelect: 'none' }}>
           <div style={{ marginRight: '15px', color: '#4B5563' }}>
             <BarChart3 size={28} />
           </div>
           <div>
              <div style={{ fontWeight: '600', color: '#374151' }}>Defaulter List</div>
...
// Reusable Tool Card Component
const ToolCard = ({ title, desc, Icon, color, iconColor, onClick }) => (
  <div onClick={onClick} className="card card-hover" style={{ ...styles.card, cursor: 'pointer' }}>
